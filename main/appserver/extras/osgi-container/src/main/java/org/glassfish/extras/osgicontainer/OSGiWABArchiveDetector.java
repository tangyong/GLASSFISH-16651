...
/**
 * Detects OSGi WAB type archives.
...
public class OSGiWABArchiveDetector implements ArchiveDetector {
    ...
    public static final String OSGI_ARCHIVE_TYPE = OSGiWABArchiveType.ARCHIVE_TYPE; // this is what is accepted in deploy --type command
    ...
    @Inject
    private OSGiWABArchiveType archiveType;
