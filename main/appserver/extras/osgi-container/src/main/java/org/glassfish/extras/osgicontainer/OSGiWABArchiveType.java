 ...
 */
@Service(name = OSGiWABArchiveType.ARCHIVE_TYPE)
@Scoped(org.jvnet.hk2.component.Singleton.class)
public class OSGiWABArchiveType extends ArchiveType {
    /**
     * String value of this module type. This is what is accepted in --type argument of deploy command.
     */
    public static final String ARCHIVE_TYPE = "wab";

    public OSGiWABArchiveType() {
